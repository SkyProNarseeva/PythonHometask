...
class Form:
    ...
    def fill_in_form(self, first_name, last_name, address, e_mail, phone, zip_code, city, country, job_position, company):   
    ...
    def zip_code_field_verify(self):
        return  self.driver.find_element(By.ID, "zip-code")
        

    def other_fields_verify(self):
